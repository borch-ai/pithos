...
Thank you for your interest in contributing to **Pithos**! We welcome pull requests, bug reports, and design suggestions. To maintain a secure, high-quality, and robust codebase, please follow the guidelines and rules described below.
...
4.  **CI Gates**: The PR checks will run formatting, lints, vulnerabilities, dependency cleanliness, and unit test coverage. If the unit test coverage falls below **91.00%**, the PR cannot be merged.
