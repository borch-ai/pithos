...
#### [MODIFY] [pre-push](file:///Users/human/code/pithos/scripts/git-hooks/pre-push)
...
#### [DELETE] [review.go](file:///Users/human/code/pithos/cmd/pithos/review.go)
- Delete the file registering the `pithos review` Cobra subcommand.

#### [DELETE] [critic.go](file:///Users/human/code/pithos/internal/review/critic.go)
- Delete the stub/implementation file for workspace verification.

#### [DELETE] [critic_test.go](file:///Users/human/code/pithos/internal/review/critic_test.go)
