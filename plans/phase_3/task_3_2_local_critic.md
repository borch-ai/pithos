...
#### [MODIFY] [pre-push](file://../../scripts/git-hooks/pre-push)
...
#### [DELETE] [review.go](file://../../cmd/pithos/review.go)
- Delete the file registering the `pithos review` Cobra subcommand.

#### [DELETE] [critic.go](file://../../internal/review/critic.go)
- Delete the stub/implementation file for workspace verification.

#### [DELETE] [critic_test.go](file://../../internal/review/critic_test.go)
